    ...
    <nav class="navbar w-full bg-base-100 shadow-sm">
      ...
      <div class="navbar-center w-4/5 max-w-180 flex justify-center">
        <div class="join w-4/5 flex justify-center">
          ...
          <button class="btn join-item rounded-r-full gap-0!"><SearchIcon />搜索</button>
        </div>
      ...
      <ul class="menu w-full grow">
        <li>
          <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" data-tip="首页">
            <HomepageIcon />
            <span class="is-drawer-close:hidden text-base ml-2 whitespace-nowrap">首页</span>     <!-- whitespace-nowrap 禁止换行 -->
          </button>
        </li>
        ...
        <li>
          <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" data-tip="好友">
            <FriendIcon />
            <span class="is-drawer-close:hidden text-base ml-2 whitespace-nowrap">好友</span>     <!-- whitespace-nowrap 禁止换行 -->
          </button>
        </li>
        ...
        <li>
          <button class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" data-tip="创作">
            <CreateIcon />
            <span class="is-drawer-close:hidden text-base ml-2 whitespace-nowrap">创作</span>     <!-- whitespace-nowrap 禁止换行 -->
          </button>
        </li>
      </ul>
    </div>
